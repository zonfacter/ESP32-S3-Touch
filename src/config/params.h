...
// Basierend auf Debug-Daten: Raw-Werte sind ~1500-2000
static constexpr int TOUCH_RAW_X_MIN = 0;
static constexpr int TOUCH_RAW_X_MAX = 2048;  // KORRIGIERT: 320 -> 2048
static constexpr int TOUCH_RAW_Y_MIN = 0;  
static constexpr int TOUCH_RAW_Y_MAX = 2048;  // KORRIGIERT: 240 -> 2048

static constexpr bool TOUCH_SWAP_XY  = false; // Scheint korrekt zu sein
